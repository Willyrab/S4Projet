...
<body>
  ...
  <div class="d-md-flex half">
    <div class="bg" style="background-image:url('<?php echo base_url('assets/img/bd_9.jpg') ?>')"></div>
    <div class="contents">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="form-block mx-auto">
              ...
              <form action="<?php echo base_url('Front-Office/Regime_controller/valid_objectif') ?> " method="post">
                <div class="form-group first">
                  <label for="username">Que souhaitez-Vous?</label>
                  <select type="text" class="form-control" placeholder="Votre taille" name="objectif">
                    <?php foreach ($objectifs as $objectif) { ?>
                      <option value="<?php echo $objectif['id'] ?>" name="objectif"><?php echo $objectif['nom'] ?></option>
                    <?php } ?>
                  </select>
                </div>

...
<body>
  ...
  <div class="d-md-flex half">
    <div class="bg" style="background-image:url('<?php echo base_url('assets/img/bd_6.jpg') ?>')"></div>
    <div class="contents">
          ...
          <div class="col-md-12">
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                <h3><strong>Code de Monnaie</strong></h3>
                <!-- <p class="mb-4">Lorem ipsum dolor sit amet elit. Sapiente sit aut eos consectetur adipisicing.</p> -->
              </div>
              <form action="<?php echo base_url('Front-Office/MonnaieController/verification') ?> " method="post">
                <div class="form-group first">
                  <label for="username">Code</label>
                  <input type="text" class="form-control" placeholder="Votre code" name="code">
                </div>
